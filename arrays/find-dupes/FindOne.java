...
public class FindOne {
	...
	public static void main(String[] args) { 
		...
		try {
			...
			Shuffle.shuffle(dat);
			System.out.println(findDupe(dat));
		...
		System.out.println("Testing findDupe2()");
		try {
			int[] a = {1,2,3,4,5,6,7,8,9,4};
			Shuffle.shuffle(a);
			System.out.println(findDupe2(a));

			int[] ab = {1,1};
			Shuffle.shuffle(ab);
			System.out.println(findDupe2(ab));

			int[] ac = {1};
			Shuffle.shuffle(ac);
			System.out.println(findDupe2(ac));
			...
			ad[0] = 435;
			Shuffle.shuffle(ad);
			System.out.println(findDupe2(ad));
